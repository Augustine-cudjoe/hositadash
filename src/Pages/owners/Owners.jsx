...
function Owners() {
  ...
  return (
    ...
    <div className=" md:w-3/4 w-full bg-slate-100 pt-24 md:mt-0 md:py-0">
       ...
       <div className=" pb-7 md:pb-0 md:px-10  " id='owners-content'>
        <h4 className=' md:py-3 md:px-5 py-2 text-xl md:text-4xl text-center '>  OUR Hospital stakeholders </h4>
          <h6 className='text-xl font-semibold py-7'> Hospital Stakeholders</h6>
